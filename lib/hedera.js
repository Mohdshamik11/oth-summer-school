 ...
 *
 * call.js is left standalone, as the course provided it (apart from the
 * private-key parsing fix and its filled-in CONFIG block), so it still works
 * as the generic template it was written to be. Everything else shares the
 * helpers below.
 */
